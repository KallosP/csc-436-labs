...
fun PizzaPartyScreen(
    ...
    // NOTE: Good practice to send only state information and callbacks
    //       to child composables, and to limit ViewModel access to only
    //       the top-level composable (such as PizzaPartyScreen in this case)
